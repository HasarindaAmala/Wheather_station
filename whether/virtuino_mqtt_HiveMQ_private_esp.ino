...
//---- WiFi settings
const char* ssid = "Dialog 4G 706";
const char* password = "d23MfdD";

//---- MQTT Broker settings
const char* mqtt_server = "e285e0ac8df4483eb93334cae8bcd4b3.s2.eu.hivemq.cloud"; // replace with your broker url
...
//SSLClient espClient;   // for no secure connection use WiFiClient instead of WiFiClientSecure 
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  //--- check the incomming message
    if( strcmp(topic,command1_topic) == 0){
     if (incommingMessage.equals("1")) digitalWrite(13, LOW);   // Turn the LED on 
     else digitalWrite(13, HIGH);  // Turn the LED off 
  }
